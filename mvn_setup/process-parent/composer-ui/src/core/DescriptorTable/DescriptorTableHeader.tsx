...
const DescriptorTableHeader: React.FC<{
  content: DeClient.TablePagination<DeClient.ServiceDescriptor>,
  setContent: React.Dispatch<React.SetStateAction<DeClient.TablePagination<DeClient.ServiceDescriptor>>>
}> = ({ content, setContent }) => {
