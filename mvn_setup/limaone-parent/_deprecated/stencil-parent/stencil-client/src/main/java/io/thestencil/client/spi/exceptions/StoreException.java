...
public class StoreException extends RuntimeException {
  ...
  public StoreException(Exception e, String code, Entity<?> target) {
    super(e.getMessage(), e);
    this.code = code;
    this.target = Optional.ofNullable(target);
  }

  public StoreException(Exception e, String code, Entity<?> target, StoreExceptionMsg ... msg) {
    super(e.getMessage(), e);
    this.code = code;
    this.target = Optional.ofNullable(target);
  ...
  public StoreException(String code, Entity<?> target) {
    super();
    this.code = code;
    this.target = Optional.ofNullable(target);
  }

  public StoreException(String code, Entity<?> target, StoreExceptionMsg ... msg) {
  ...
  private static String formatMessages(String code, Entity<?> target, StoreExceptionMsg ... msg) {
