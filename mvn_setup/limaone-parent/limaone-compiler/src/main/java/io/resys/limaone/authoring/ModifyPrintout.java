...
public interface ModifyPrintout {

  ModifyPrintout props(ModifyPrintoutProps props);
  ModifyPrintout props(Consumer<ImmutableModifyPrintoutProps.Builder> props);

  Uni<Model<Printout>> build();
  Model<Printout> buildSync();


  @Value.Immutable @JsonSerialize(as = ImmutableModifyPrintoutProps.class) @JsonDeserialize(as = ImmutableModifyPrintoutProps.class)
  interface ModifyPrintoutProps extends AuthoringModelProps {
    String getServiceId();
