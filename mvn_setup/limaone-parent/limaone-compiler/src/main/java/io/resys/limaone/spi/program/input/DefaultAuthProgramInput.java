...
import io.resys.limaone.program.ArticleProgram.AuthProgramInput;
import io.resys.limaone.program.ProgramInput;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class DefaultAuthProgramInput implements AuthProgramInput {
  ...
  public ProgramInput withInputs(Map<String, Serializable> nextInputs) {
    return new DefaultAuthProgramInput(delegate.withInputs(nextInputs), locale, targetDate, user);
  }
  @Override
  ...
  public static class Builder {
    ...
    public DefaultAuthProgramInput build() {
      ...
      return new DefaultAuthProgramInput(input, locale, Optional.ofNullable(targetDate).orElse(OffsetDateTime.now()), user);
    }
  }
}
