...
public interface ArticleProgram extends Program {
  ...
  ArticleProgramResult run(ArticleProgramInput input);
  AuthProgramResult run(AuthProgramInput input);
  

  
  interface ArticleProgramInput extends ProgramInput {
    OffsetDateTime getTargetDate();
    Participant getParticipant();
  }
  
  interface AuthProgramInput extends ProgramInput {
    OffsetDateTime getTargetDate();
    Participant getParticipant();
  }

  @Value.Immutable @JsonSerialize(as = ImmutableAuthProgramResult.class) @JsonDeserialize(as = ImmutableAuthProgramResult.class)
  interface AuthProgramResult extends ProgramResult {
