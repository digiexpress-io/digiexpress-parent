...
public class WorldPersistenceLogger {
  public void stage1TenantConfigured(FileSystemTenant tenant, UUID commitId) {
    
  }
  
  public void stage2CurrentState(Optional<Ref> ref) {
    
  }
  public void stage3LockFailed(Optional<Ref> ref) {
