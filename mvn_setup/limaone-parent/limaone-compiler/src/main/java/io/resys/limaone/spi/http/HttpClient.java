...
public interface HttpClient {
  ...
  interface RawResponse {
    ...
    /**
     * @return actual HTTP response from whatever the implementation provides, with body and status code etc... safe to return via rest api.
     */
    Object unwrap();
  }
  ...
  interface AnyProxy {
    AnyProxy path(String path);
    AnyProxy query(@Nullable String query);
    AnyProxy httpMethod(String httpMethod); 
    AnyProxy body(@Nullable String body);
    AnyProxy headers(Map<String, String> headers);
