...
import io.digiexpress.mig.client.api.MigClient.TargetWrenchBuilder;
...
delete from wrench_ass11_git_treeitems;
delete from wrench_ass11_git_trees;
delete from wrench_ass11_git_blobs;
   */
