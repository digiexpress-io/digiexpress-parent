...
public class DialobReviewAssert {
  public static class DialobReviewException extends RuntimeException {
    private static final long serialVersionUID = 1781444267360040922L;
  
    public DialobReviewException(String message, Throwable cause) {
      super(message, cause);
    }
  
    public DialobReviewException(String message) {
      super(message);
    }
  }
  public static void notNull(Object object, Supplier<String> message) {
    if (object == null) {
      throw new DialobReviewException(getMessage(message));
    }
  }
