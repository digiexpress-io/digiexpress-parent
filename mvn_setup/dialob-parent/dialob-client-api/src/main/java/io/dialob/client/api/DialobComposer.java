...
public interface DialobComposer {
  ...
  DialobComposer withTenantId(String tenantId);
  
  interface DialobTenantQuery {
    DialobComposer get(String tenantId);
    Uni<DialobComposer> deleteAll();
    Uni<DialobComposer> delete();
    Uni<DialobComposer> create();
    Uni<DialobComposer> createIfNot();
  } 
