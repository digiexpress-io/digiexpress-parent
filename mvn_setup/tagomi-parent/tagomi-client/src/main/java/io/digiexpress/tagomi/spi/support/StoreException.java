package io.digiexpress.tagomi.spi.support;
...
public class StoreException extends RuntimeException {
  ...
  public StoreException(String code, TagomiContainer.IsTagomiObject target, StoreExceptionMsg ... msg) {
  ...
  private static String formatMessages(String code, TagomiContainer.IsTagomiObject target, StoreExceptionMsg ... msg) {
  ...
  public Optional<TagomiContainer.IsTagomiObject> getTarget() {
    return target;
  }
