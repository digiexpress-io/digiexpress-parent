...
public class ClasspathExternalDeploymentProvider implements ExternalDeploymentProvider {
  ...
  public ClasspathExternalDeploymentProvider(InputStream input, ObjectMapper objectMapper) {
    try {
      this.deployment = objectMapper.readValue(input, EveliDeployment.class);
    } catch (Exception e) {
