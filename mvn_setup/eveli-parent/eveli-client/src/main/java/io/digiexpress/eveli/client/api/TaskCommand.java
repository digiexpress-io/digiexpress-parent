...
import io.digiexpress.eveli.client.api.TaskClient.ChecklistItem;
...
@JsonSubTypes({
  @Type(value = ImmutableCreateTaskCommand.class, name = "CreateTask"),
  ...
  @Type(value = ImmutableCreateTaskCommentCommand.class, name = "CommentOnTask"),
  @Type(value = ImmutableModifyTaskCommand.class, name = "ModifyTask"),
...
public interface TaskCommand extends Serializable {
  ...
  enum TaskCommandType {
    CreateTask, ModifyTask, ChangeTaskStatus, ChangeTaskPriority, AssignTaskReporter, 
  ...
  interface TaskUpdateCommand extends TaskCommand {
    ...
    TaskUpdateCommand withTaskId(String taskId);
