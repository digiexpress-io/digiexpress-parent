...
import io.resys.thena.git.api.GitQueries;
import io.resys.thena.git.spi.builders.GitBlobCommitQuerySqlPool;
import io.resys.thena.git.spi.builders.GitBlobHistoryQuerySqlPool;
import io.resys.thena.git.spi.builders.GitBlobQuerySqlPool;
import io.resys.thena.git.spi.builders.GitCommitQuerySqlPool;
import io.resys.thena.git.spi.builders.GitRefQuerySqlPool;
import io.resys.thena.git.spi.builders.GitTagQuerySqlPool;
import io.resys.thena.git.spi.builders.GitTreeQuerySqlPool;
