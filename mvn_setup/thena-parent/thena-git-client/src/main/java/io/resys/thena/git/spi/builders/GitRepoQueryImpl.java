...
public class GitRepoQueryImpl implements GitTenantQuery {
  ...
  private Uni<QueryEnvelope<GitRepoObjects>> getState(GitState ctx) {
  ...
  private Uni<GitRepoObjects> getRefs(GitState ctx) {
  ...
  private Uni<GitRepoObjects> getTrees(GitState ctx) {
  ...
  private Uni<GitRepoObjects> getCommits(GitState ctx) {
