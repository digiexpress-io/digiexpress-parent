...
import io.resys.thena.git.api.GitQueries.GitCommitQuery;
import io.resys.thena.git.api.GitQueries.LockCriteria;
...
public class GitCommitQuerySqlPool implements GitCommitQuery {
  ...
  public GitCommitQuerySqlPool(ThenaSqlDataSource dataSource) {
    ...
    this.registry = new GitRegistrySqlImpl(dataSource.getRegistry()).commits();
