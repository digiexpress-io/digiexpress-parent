...
@Slf4j
public class GitDataSourceImpl implements GitDataSource {
  ...
  public InternalTenantQuery tenant() {
    return new GitInternalTenantQuery(dataSource);
  }
  ...
  public static GitDataSourceImpl create(TenantContext names, io.vertx.mutiny.sqlclient.Pool client, TenantCache tenantCache) {
    ...
    return new GitDataSourceImpl(dataSource);
  }
  ...
  public static class Builder {
    ...
    public GitClient build() {
      ...
      final var state = new GitDataSourceImpl(dataSource);
      return new GitClientImpl(state);
    }
  }
}
