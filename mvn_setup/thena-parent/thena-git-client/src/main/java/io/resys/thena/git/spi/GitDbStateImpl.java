...
import io.resys.thena.git.api.GitDataSource.TransactionFunction;
import io.resys.thena.git.spi.builders.GitDbInsertsSqlPool;
import io.resys.thena.git.api.GitInserts;
