...
public class SqlDbSchemaPrintTest {
  ...
  public void printSchema() throws IOException {
    ...
    final var schema = new StringBuilder()
      ...
      .branchContent(doc.docLogs().createTable().getValue())
      .branchContent(doc.docLogs().createConstraints().getValue())
      
      
      .branchContent(org.orgRights().createTable().getValue())
      .branchContent(org.orgParties().createTable().getValue())
      .branchContent(org.orgPartyRights().createTable().getValue())
      .branchContent(org.orgMembers().createTable().getValue())
      .branchContent(org.orgMemberRights().createTable().getValue())
      .branchContent(org.orgMemberships().createTable().getValue())
      .branchContent(org.orgCommits().createTable().getValue())
      .branchContent(org.orgRights().createConstraints().getValue())
      .branchContent(org.orgMembers().createConstraints().getValue())
      .branchContent(org.orgParties().createConstraints().getValue())
      .branchContent(org.orgCommits().createConstraints().getValue())
