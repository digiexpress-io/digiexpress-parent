...
public class OrgActorStatusQuerySqlPool implements OrgQueries.ActorStatusQuery {
  ...
  public Multi<OrgActorStatus> findAll() {
    final var sql = registry.orgActorStatus().findAll();
    ...
    return wrapper.getClient().preparedQuery(sql.getValue())
        .mapping(registry.orgActorStatus().defaultMapper())
        .execute()
        .onItem()
  ...
  public Uni<OrgActorStatus> getById(String id) {
    final var sql = registry.orgActorStatus().getById(id);
    if(log.isDebugEnabled()) {
  ...
  public Multi<OrgActorStatus> findAllByRightId(String id) {
    final var sql = registry.orgActorStatus().findAllByIdRightId(id);
    if(log.isDebugEnabled()) {
  ...
  public Multi<OrgActorStatus> findAllByMemberId(String id) {
    final var sql = registry.orgActorStatus().findAllByMemberId(id);
    if(log.isDebugEnabled()) {
  ...
  public Multi<OrgActorStatus> findAllByPartyId(String id) {
    final var sql = registry.orgActorStatus().findAllByPartyId(id);
    if(log.isDebugEnabled()) {
