...
import io.resys.thena.docdb.store.sql.queries.GitBlobHistoryQuerySqlPool;
import io.resys.thena.docdb.store.sql.queries.GitBlobQuerySqlPool;
import io.resys.thena.docdb.store.sql.queries.GitCommitQuerySqlPool;
import io.resys.thena.docdb.store.sql.queries.GitRefQuerySqlPool;
import io.resys.thena.docdb.store.sql.queries.GitTagQuerySqlPool;
import io.resys.thena.docdb.store.sql.queries.GitTreeQuerySqlPool;
