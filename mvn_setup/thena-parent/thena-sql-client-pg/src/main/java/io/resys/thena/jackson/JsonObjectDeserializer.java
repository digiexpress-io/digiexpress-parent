...
public class JsonObjectDeserializer extends StdDelegatingDeserializer<JsonObject> {
  ...
  private static final long serialVersionUID = -7749649544676032343L;
  ...
  @Override
  protected StdDelegatingDeserializer<JsonObject> withDelegate(
      Converter<Object, JsonObject> converter, 
