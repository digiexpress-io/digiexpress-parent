...
public class BatchDbInternalTenantQuery extends InternalTenantQueryImpl implements InternalTenantQuery {

  public BatchDbInternalTenantQuery(ThenaSqlDataSource dataSource) {
    super(dataSource);
  }
  ...
  public Uni<Tenant> insert(final Tenant newRepo) {
    ...
    final var registry = new BatchTenantRegistryImpl(next.getRegistry());
    ...
    return pool.withTransaction(tx -> {
      ...
      RepoAssert.isTrue(newRepo.getType() == StructureType.batch, () -> "Tenant type must be batch");

      
      
      tablesCreate
      .append(registry.getBatches().createTable().getValue())
      .append(registry.getBatchConsumers().createTable().getValue())
      .append(registry.getRuntimeInstances().createTable().getValue())
      .append(registry.getRuntimeLogs().createTable().getValue())
      .append(registry.getRuntimeMetrics().createTable().getValue())
      .append(registry.getRuntimeParams().createTable().getValue())
      .append(registry.getRuntimeSteps().createTable().getValue())
      .append(registry.getRuntimeStepRows().createTable().getValue())
      
      
      .append(registry.getBatches().createConstraints().getValue())
      .append(registry.getBatchConsumers().createConstraints().getValue())
      .append(registry.getRuntimeInstances().createConstraints().getValue())
      .append(registry.getRuntimeLogs().createConstraints().getValue())
      .append(registry.getRuntimeMetrics().createConstraints().getValue())
      .append(registry.getRuntimeParams().createConstraints().getValue())
      .append(registry.getRuntimeSteps().createConstraints().getValue())
      .append(registry.getRuntimeStepRows().createConstraints().getValue())
      .toString();
  ...
  public Uni<Tenant> delete(final Tenant newRepo) {
    ...
    return pool.withTransaction(tx -> {
      ...
      tablesDrop
      .append(registry.getRuntimeLogs().dropTable().getValue())
      .append(registry.getRuntimeMetrics().dropTable().getValue())
      .append(registry.getRuntimeParams().dropTable().getValue())
      
      .append(registry.getRuntimeStepRows().dropTable().getValue())
      .append(registry.getRuntimeSteps().dropTable().getValue())
      .append(registry.getRuntimeInstances().dropTable().getValue())
      .append(registry.getBatchConsumers().dropTable().getValue())
      
      .append(registry.getBatches().dropTable().getValue());
