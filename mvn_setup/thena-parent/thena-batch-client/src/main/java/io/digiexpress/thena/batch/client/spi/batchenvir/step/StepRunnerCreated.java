...
public class StepRunnerCreated {
  ...
  public Uni<RuntimeStep> accept() {
    return context.getDb()
        ...
        .onItem().invoke(step -> {
          BatchEnvirLogger.STEP_CREATED
            .withContext(this.context)
            .addProps(config)
            .append("Created runtime instance step");
        });
  }
