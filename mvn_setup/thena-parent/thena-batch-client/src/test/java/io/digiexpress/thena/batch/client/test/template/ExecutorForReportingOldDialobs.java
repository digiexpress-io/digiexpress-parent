...
public class ExecutorForReportingOldDialobs implements Executor<ExecutorForReportingOldDialobs.EntityForTesting, ExecutorForReportingOldDialobs.ExecutorConfigForTesting> {
