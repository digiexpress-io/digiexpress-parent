...
@Slf4j
public class Merge_Test extends DbTestTemplate {
  ...
  public void merge() {
    ...
    final var commit_2 = fs
      ...
      .mergeFile("root/xyz/xxx.txt", (prev, newFile) -> newFile
          .fileValue(JsonObject.of("firstName", "Lady Sybil", "lastName", "Vimes"))
          .build())
      .build()
      .await().atMost(atMost);
...
Branch updated: main commit02..commit01
    ...
    { // pull 2 files
      ...
      Assertions.assertEquals(blob.getBlobValue().getString("firstName"), "Lady Sybil");
