...
@Slf4j
public class RenameFolder_Test extends DbTestTemplate {
  ...
  public void renameFolder() {
    ...
    final var tenant = "MVFolder_Test";
    ...
    fs
      .commitBuilder()
      .commitAuthor("john smith")
      .commitMessage("Renaming folder")
      .mergeFolder("root/xyz/xxx", (prev, merge) -> merge
          .folderName("yyy")
          .build())
      .build()
      .await().atMost(atMost);
