...
@Value.Immutable
@JsonSerialize(as = ImmutableCockpitConfigCommitTree.class)
@JsonDeserialize(as = ImmutableCockpitConfigCommitTree.class)
public interface CockpitConfigCommitTree extends CockpitEntity {
  String getId();
  String getCommitId();
