...
public class DocInternalTenantQueryImpl extends InternalTenantQueryImpl implements InternalTenantQuery {

  public DocInternalTenantQueryImpl(ThenaSqlDataSource dataSource) {
    super(dataSource);
  }

  @Override
  public Uni<Tenant> insert(final Tenant newRepo) {
    RepoAssert.isTrue(newRepo.getType() == StructureType.doc, () -> "Tenant type must be doc");
