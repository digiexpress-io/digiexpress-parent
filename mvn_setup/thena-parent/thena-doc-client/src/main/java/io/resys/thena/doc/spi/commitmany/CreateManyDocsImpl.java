...
import io.resys.thena.doc.spi.support.BatchForOneDocCreate;
...
public class CreateManyDocsImpl implements CreateManyDocs {
  ...
  public AddItemToCreateDoc item() {
    ...
    lasItemBuilder = new AddItemToCreateDoc() {
      ...
      @Override public AddItemToCreateDoc docDescription(String docDescription) { oneDoc.docDescription(docDescription); return this; }
