...
import io.resys.thena.doc.spi.support.ExMessageFormatter.DocumentExceptionMsg;
...
public class DocStoreException extends RuntimeException {
  ...
  public DocStoreException(String code, DocumentExceptionMsg ... msg) {
    super(new ExMessageFormatter(code, null, msg).format());
    this.code = code;
    this.messages.addAll(Arrays.asList(msg));
    this.target = null;
  }
  public DocStoreException(String code, JsonObject target, DocumentExceptionMsg ... msg) {
  ...
  public static class Builder {
    ...
    public DocStoreException build() {
      return new DocStoreException(id, msg.build());
    }
  }
}
