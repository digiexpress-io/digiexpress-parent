...
import io.resys.thena.grim.spi.datasource.GrimMissionDataRegistry;
import io.resys.thena.grim.spi.datasource.GrimMissionFilter;
...
public class GrimMissionDataRegistrySqlImpl implements GrimMissionDataRegistry {
  ...
  public SqlTuple findAllByMissionIds(GrimMissionFilter filter) {
    ...
    return ImmutableSqlTuple.builder()
        ...
        .append(" ON(mission_data.mission_id = mission.id)")
  ...
  public SqlTupleList deleteAllByMissionId(Collection<String> missionId) {
    return ImmutableSqlTupleList.builder()
        .value(new SqlStatement()
        .append("DELETE FROM ").append(options.getGrimMissionData())
  ...
  @Override
  public SqlTupleList deleteAll(Collection<GrimMissionData> links) {
    return ImmutableSqlTupleList.builder()
        .value(new SqlStatement()
        .append("DELETE FROM ").append(options.getGrimMissionData())
        .append(" WHERE id = $1")
