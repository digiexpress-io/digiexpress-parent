...
import io.resys.thena.grim.spi.create.NewMissionCommitViewerBuilder;
...
public class MergeMissionBuilder implements MergeMission {
    ...
    this.nextMissionMeta = ImmutableGrimMissionData.builder()
        .from(container
            ...
            .findFirst().orElseGet(() -> {
              ...
              final GrimMissionData data = ImmutableGrimMissionData.builder()
                  .id(OidUtils.gen())
  ...
  public MergeMission title(String title) {
    this.nextMission.title(title);
    return this;
  }
  @Override
  public MergeMission description(String description) {
    this.nextMission.description(description);
    return this;
  }
  @Override
  ...
  public MergeMission addViewer(Consumer<NewMissionCommitViewer> viewer) {
    ...
    if(viewed.isPresent()) {
      this.batch.addCommitViewers(viewed.get());
    }
