...
public class OperationFlowContext {
  ...
  public static Operation<?> build(String src, Consumer<String> constants) {
    Objects.requireNonNull(src, () -> "expression can't be null!");
    
    final SpelExpression exp = (SpelExpression) PARSER.parseExpression(src);
