...
public class IdFixer {
  ...
  public MutableHeader getHeader(String id) {
    RepoAssert.isTrue(headers.containsKey(id), () -> "no header with id: " + id + "!");
    return headers.get(id);
  }
  public MutableCell getCell(String id) {
    RepoAssert.isTrue(cells.containsKey(id), () -> "no cell with id: " + id + "!");
    return cells.get(id);
  }
  public MutableRow getRow(String id) {
    RepoAssert.isTrue(rows.containsKey(id), () -> "no row with id: " + id + "!");
    return rows.get(id);
  }
