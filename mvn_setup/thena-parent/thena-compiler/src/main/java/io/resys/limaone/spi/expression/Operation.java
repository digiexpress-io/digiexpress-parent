...
public interface Operation<T> {
  ...
  public static Operation<Object> and(Operation ... values) {
    final Collection<Operation> operations = Collections.unmodifiableList(Arrays.asList(values));
    return (final Object parameter) -> {
        for(final Operation value : operations) {
