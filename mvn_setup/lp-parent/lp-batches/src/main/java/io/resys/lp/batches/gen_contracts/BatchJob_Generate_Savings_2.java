...
import io.resys.lp.batches.gen_contracts.BatchJob_Generate_Savings_2.GeneratorConfig;
...
public class BatchJob_Generate_Savings_2 implements Executor<String, GeneratorConfig> {
  ...
  public Uni<ExecutorEntity> accept(String refNumber, GeneratorConfig config, ExecutorContext context) {
    return Contract_Provider.newNovaVirtus(contractClient, ledgerClient, refNumber)
