...
import io.resys.thena.tasks.client.thenagit.store.DocumentConfig.DocPullObjectsVisitor;
...
public class GetActiveTasksByIdsVisitor implements DocPullObjectsVisitor<Task> {
  ...
  @Override
  public List<Task> end(DocumentConfig config, GitPullActions.PullObjects blob) {
