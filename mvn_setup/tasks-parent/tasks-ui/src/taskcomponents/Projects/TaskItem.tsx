...
import DaysUntilDue from 'taskcomponents/DaysUntilDue';
...
const TaskItem: React.FC<{ task: TaskDescriptor }> = ({ task }) => {
  ...
  return (
    <Box display='flex' width='100%' alignItems='center'>
      ...
      <Box width='30%' justifyItems='left'><Typography fontWeight='bolder'><DaysUntilDue daysUntilDue={task.daysUntilDue} /></Typography></Box>
