...
public class DialobMigrationVisitor {
  ...
  public void visitFormRev(DialobFormMeta src) {
    SysConfigAssert.isTrue(!revisions.containsKey(src.getId()), () -> "Can't redefine form revision id: " + src.getId());
  ...
  public void visitTag(DialobFormTag src) {
    SysConfigAssert.isTrue(revisions.containsKey(src.getFormName()), () -> "Can't find form revision id: " + src.getFormName());
  ...
  public void visitForm(Form src) {
    ...
    SysConfigAssert.isTrue(!forms.containsKey(src.getId()), () -> "Can't redefine form id: " + src.getId());
