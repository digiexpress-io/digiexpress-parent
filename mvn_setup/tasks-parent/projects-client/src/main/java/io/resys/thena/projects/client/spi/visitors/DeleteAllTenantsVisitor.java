...
public class DeleteAllTenantsVisitor implements DocObjectsVisitor<Uni<List<TenantConfig>>>{
  ...
  @Override
  public Uni<QueryEnvelope<DocTenantObjects>> start(DocumentConfig config, DocObjectsQuery query) {
  ...
  @Override
  public Uni<List<TenantConfig>> end(DocumentConfig config, DocTenantObjects ref) {
    if(ref == null) {
