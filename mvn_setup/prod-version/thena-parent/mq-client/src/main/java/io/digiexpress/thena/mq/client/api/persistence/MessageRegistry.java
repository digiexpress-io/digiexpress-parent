...
public interface MessageRegistry extends ThenaMqRegistryTemplate<PublishedMessage, io.vertx.mutiny.sqlclient.Row> {

  ThenaSqlClient.SqlTupleList insertMany(List<PublishedMessage> docs);
  ...
  @Override Function<io.vertx.mutiny.sqlclient.Row, PublishedMessage> defaultMapper();
}
