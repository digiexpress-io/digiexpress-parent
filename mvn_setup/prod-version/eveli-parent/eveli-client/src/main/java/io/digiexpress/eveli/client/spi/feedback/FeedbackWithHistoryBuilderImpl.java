...
public class FeedbackWithHistoryBuilderImpl implements FeedbackWithHistoryBuilder {
  ...
  @Override
  public FeedbackWithHistoryBuilder append(UpsertFeedbackRankingCommand command, FeedbackRating rating) {
    final var event = new FeedbackHistoryEntity()
        .setId(null)// auto generated by db
        .setCommitId(commitId)
        .setCategoryId(rating.getCategoryId())
        .setCreatedBy(command.getCustomerId())
  ...
  @Override
  public FeedbackWithHistoryBuilder append(CreateFeedbackCommand command, Feedback feedback) {
    final var event = new FeedbackHistoryEntity()
        .setId(null)// auto generated by db
        .setCommitId(commitId)
  ...
  @Override
  public FeedbackWithHistoryBuilder append(DeleteReplyCommand command, List<Feedback> allFeedback) {
