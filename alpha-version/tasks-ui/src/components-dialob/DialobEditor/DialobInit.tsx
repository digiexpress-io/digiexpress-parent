...
import { DEFAULT_ITEM_CONFIG, DEFAULT_ITEMTYPE_CONFIG, DialobComposer, createDialobComposerReducer, createDialobComposerMiddleware } from 'components-dialob-composer';
import './fixes.css'
