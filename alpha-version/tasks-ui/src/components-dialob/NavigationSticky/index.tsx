...
import { NavigationSticky as Sticky } from 'components-generic';
...
export const NavigationSticky: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  return (<Sticky extendedAppBar={(<><Divider /><DialobItemHeaders /></>)}>{children}</Sticky>);
}
