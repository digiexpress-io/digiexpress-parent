...
public class ServiceExecutorException extends RuntimeException {
  ...
  public static ServiceExecutorException processNotFound(ServiceWrapper wrapper, String nameOrId, Supplier<String> msg) {
    return new ServiceExecutorException("Process not found by name or id: '" + nameOrId + "'!" + System.lineSeparator() + msg.get());
  }
  
  public static ServiceExecutorException processInitVariableAlreadyDefined(ServiceWrapper wrapper, ProcessValue process, Supplier<String> msg) {
