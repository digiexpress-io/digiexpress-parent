const en = {
  ...
  'dialob.form.variables': 'Variables',
  ...
  'dialob.form.create.dialog.technicalName': 'Form title',
  ...
  'task.checklist.item.title': 'To-do item',
  'task.checklist.addItem': 'Add to-do item',
  'task.checklist.item.dueDate': 'Due date',
  'task.checklist.add': 'New checklist',
  'task.checklist.delete': 'Delete checklist',
  'task.checklistItem.add': 'Add item',
  ...
  'task.event.createTask': 'Task created',
  'task.event.assignTask': 'Task assigned to users',
  'task.event.assignTaskRoles': 'Task assigned to roles',
  ...
  'task.event.changeChecklistItemDueDate': 'Checklist item due date changed',
  'task.event.changeChecklistTitle': 'Checklist title changed',
  'task.event.changeChecklistItemTitle': 'Checklist item title changed',
  'task.event.changeChecklistItemCompleted': 'Checklist item marked as complete',
  'task.event.changeChecklistItemNotCompleted': 'Checklist item marked as incomplete',
  'task.event.deleteChecklist': 'Checklist deleted',
  'task.event.deleteChecklistItem': 'Checklist item deleted',
  ...
  'core.taskCreate.button.createAndClose': 'Create and close',
  'core.taskCreate.button.createAndEdit': 'Create and edit',
  'core.taskCreate.button.cancel': 'Cancel',
  ...
  'core.taskWork.attachments.add': 'Add attachment',
  'core.taskWork.attachments.none': 'No attachments yet',

  'core.taskWork.messages.start': 'Start thread',
  'core.taskWork.messages.none': 'No messages yet',

  'core.taskWork.checklists.add': 'Add checklist',
  'core.taskWork.checklists.none': 'No checklists yet',
