...
import { GInboxSubjectNewMessageRoot, MUI_NAME, useUtilityClasses } from './useUtilityClasses';

export interface GInboxSubjectNewMessageProps {
  senderName?: string;
  subjectName: string;
  minRows?: number | undefined;
}

export const GInboxSubjectNewMessage: React.FC<GInboxSubjectNewMessageProps> = (initProps) => {
  const intl = useIntl();
  ...
  return (
    <GInboxSubjectNewMessageRoot className={classes.newMsgRoot}>
