...
export declare namespace Command_RunNodeCommand {
...
export class Command_RunNodeCommand {
 execute(input: Command_RunNodeCommand.Input): Command_RunNodeCommand.Result {
