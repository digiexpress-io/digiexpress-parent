...
interface Action {
  ...
  setDebugUpdate?: WrenchComposerApi.DebugSession;
...
const ActionBuilder = {
  ...
  setDebugUpdate: (setDebugUpdate: WrenchComposerApi.DebugSession) => ({ type: ActionType.setDebugUpdate, setDebugUpdate }),
  setBranchUpdate: (setBranchUpdate?: string) => ({ type: ActionType.setBranchUpdate, setBranchUpdate })
}

class ReducerDispatch implements WrenchComposerApi.Actions {
  ...
  handleDebugUpdate(debug: WrenchComposerApi.DebugSession): void {
...
const Reducer = (state: WrenchComposerApi.Session, action: Action): WrenchComposerApi.Session => {
  switch (action.type) {
