...
export const MUI_NAME = 'EveliLayout';

export const useUtilityClasses = (ownerState: EveliLayoutProps) => {
  const slots = {
...
export const EveliLayoutRoot = styled('div', {
  name: MUI_NAME,
  slot: 'Root',
  ...
  return {
    width: "100%",
    '& .EveliLayout-topTitle': {
      paddingLeft: theme.spacing(2),
      margin: theme.spacing(1),
    },
    '& .EveliLayout-breadcrumbs': {
    ...
    '& .EveliLayout-oneColContent': {
      padding: 'unset'
    },
    '& .EveliLayout-fillSessionStartEndLayout': {
      justifyContent: 'center'
    },
    '& .EveliLayout-fillSessionStartEnd': {
    ...
    '& .EveliLayout-fillSessionStartEndTopTitle': {
      marginBottom: theme.spacing(5),
    },
    '& .EveliLayout-fillSessionStartEndChildren': {
    ...
    '& .EveliLayout-oneColContentSmall': {
 ...
 * One row in the bar
 */
export const EveliLayoutRow = styled('div', {
  name: MUI_NAME,
  slot: 'Row',
  overridesResolver: (_props, styles) => {
    return [
 ...
 */
export function useEveliLayoutRows(init: React.ReactNode) {
