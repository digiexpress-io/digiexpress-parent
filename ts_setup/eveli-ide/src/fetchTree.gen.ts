...
import { Hook as orgGroupListGET } from './fetch/$org.groupList.get.ts'
...
import { Hook as statisticsPriorityGET } from './fetch/statistics.priority.ts'
import { Hook as statisticsStatusTimelineGET } from './fetch/statistics.status-timeline.ts'
import { Hook as statisticsStatusGET } from './fetch/statistics.status.ts'
import { Hook as statisticsTaskOverdueGET } from './fetch/statistics.task-overdue.ts'
import { Hook as workerRestApiAssetsAnyTagsStencilTagsGET } from './fetch/worker.rest.api.assets.any-tags.stencil-tags.get.ts'
import { Hook as workerRestApiAssetsAnyTagsWrenchTagsGET } from './fetch/worker.rest.api.assets.any-tags.wrench-tags.get.ts'
...
import { Hook as workerRestApiAssetsStencilVersionGET } from './fetch/worker.rest.api.assets.stencil.version.get.ts'
...
import { Hook as workerRestApiAssetsWrenchVersionGET } from './fetch/worker.rest.api.assets.wrench.version.get.ts'
...
import { Hook as workerRestApiPdfGET } from './fetch/worker.rest.api.pdf.get.ts'
...
const orgGroupListGETRoute = orgGroupListGET.update({
  path: '$org/groupList',
  method: 'GET',
})
...
const statisticsPriorityGETRoute = statisticsPriorityGET.update({
  path: 'statistics/priority',
  method: 'GET',
})

const statisticsStatusTimelineGETRoute = statisticsStatusTimelineGET.update({
  path: 'statistics/status-timeline',
  method: 'GET',
})

const statisticsStatusGETRoute = statisticsStatusGET.update({
  path: 'statistics/status',
  method: 'GET',
})

const statisticsTaskOverdueGETRoute = statisticsTaskOverdueGET.update({
  path: 'statistics/task-overdue',
  method: 'GET',
})

const workerRestApiAssetsAnyTagsStencilTagsGETRoute = workerRestApiAssetsAnyTagsStencilTagsGET.update({
  path: 'worker/rest/api/assets/any-tags/stencil-tags',
  method: 'GET',
})

const workerRestApiAssetsAnyTagsWrenchTagsGETRoute = workerRestApiAssetsAnyTagsWrenchTagsGET.update({
...
const workerRestApiAssetsStencilVersionGETRoute = workerRestApiAssetsStencilVersionGET.update({
...
const workerRestApiAssetsWrenchVersionGETRoute = workerRestApiAssetsWrenchVersionGET.update({
...
const workerRestApiPdfGETRoute = workerRestApiPdfGET.update({
...
declare module '@dxs-ts/eveli-fetch' {
  interface HookByPath {
    ...
    '$org/groupList.GET': {
      ...
      method: 'GET',
      params: {org: string},
      hook: typeof orgGroupListGETRoute
    }
    ...
    'worker/rest/api/assets/stencil/version.GET': {
      id: 'worker/rest/api/assets/stencil/version.GET',
      path: 'worker/rest/api/assets/stencil/version',
      method: 'GET',
      params: {},
      hook: typeof workerRestApiAssetsStencilVersionGETRoute
    }
