export const en = {
  ...
  'fs.dirent.printout.sectionTitle.localeLabels': 'Labels by language',
  'fs.dirent.printout.labelField.en.label': 'Label (English)',
  'fs.dirent.printout.labelField.fi.label': 'Label (Finnish)',
  'fs.dirent.printout.labelField.sv.label': 'Label (Swedish)',
