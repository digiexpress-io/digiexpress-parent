export const en = {
  ...
  'tagomi.template.delete.desc': 'Choose a template to delete. Deleted templates will no longer be available for use.',
  'tagomi.template.selectTemplate': 'Selected template',
  'tagomi.button.delete.template': 'Delete',
  'tagomi.template.delete.noTemplates.helperText': 'No available templates to delete'
}