export const en = {
  ...
  'task.transfer.create.receivedFiles': 'Received documents',
  ...
  'inHouseTable.title': 'In-house services',
  'inHouseTable.col.header.name': 'Name',
  ...
  'eveli.userProfile.tenantConfig.select.metis.desc': 'Show / hide the Metis status and reindex page',
  ...
  'eveli.userProfile.tenantConfig.select.in_house': 'In-house',
  'eveli.userProfile.tenantConfig.select.in_house.desc': 'Enable in-house form-filling based on copy-pasted links',
  ...
  'toolbar.tagomi': 'PDF Service',
  'tagomi.services.searchAll': 'Search all PDF services',
  ...
  'tagomi.service.create.dialog.orchestratorName': 'Process name',
  'tagomi.service.edit.dialog.title': 'Edit service:',
  'tagomi.service.edit.dialog.name': 'Service name',
  'tagomi.service.edit.dialog.orchestratorName': 'Process name',
  ...
  'fs.articleLocaleOverview.title': 'Article Locale Overview',
  'fs.articleLocaleOverview.col.article': 'Article',
  'fs.articleLocaleOverview.col.article.desc': 'Checkmark indicates a page in the given language',
  'fs.direntStats.title': 'Asset Statistics',
  'fs.direntStats.section.overview': 'Asset Overview Count',
  'fs.direntStats.section.dangling': 'Dangling Assets',
  'fs.direntStats.section.disabled': 'Disabled Assets',
  'fs.direntStats.dangling.articles.desc': 'No pages created',
  'fs.direntStats.dangling.workflows.desc': 'Not connected to any article',
  'fs.direntStats.dangling.links.desc': 'No articles assigned',
  'fs.direntStats.dangling.flows.desc': 'Not used in any workflow',
  'fs.direntStats.dangling.folders.desc': 'Empty folder',
  'fs.direntStats.dangling.flowTasks.desc': 'TODO',
  'fs.direntStats.dangling.decisionTables.desc': 'TODO',
  'fs.direntStats.dangling.forms.desc': 'TODO',
  'fs.direntStats.dangling.printouts.desc': 'TODO',
  'fs.direntStats.section.overview.assetType.ARTICLE': 'Articles',
  'fs.direntStats.section.overview.assetType.ARTICLE_LINK': 'Article Links',
  'fs.direntStats.section.overview.assetType.ARTICLE_PAGE': 'Article Pages',
  'fs.direntStats.section.overview.assetType.ARTICLE_WORKFLOW': 'Article Workflows',
  'fs.direntStats.section.overview.assetType.FLOW': 'Flows',
  'fs.direntStats.section.overview.assetType.FLOW_TASK': 'Flow Tasks',
  'fs.direntStats.section.overview.assetType.LOCALE': 'Locales',
  'fs.direntStats.section.overview.assetType.ARTICLE_TEMPLATE': 'Article Templates',
  'fs.direntStats.section.overview.assetType.DECISION_TABLE': 'Decision Tables',
  'fs.direntStats.section.overview.assetType.DIALOB_FORM': 'Forms',
  'fs.direntStats.section.overview.assetType.PRINTOUT': 'Printouts',
  'fs.direntStats.section.overview.assetType.PRINTOUT_PAGE': 'Printout Pages',
  'fs.direntStats.section.overview.assetType.PRINTOUT_RESOURCE': 'Printout Resources',
  'fs.direntStats.section.overview.assetType.DEPLOYMENT': 'Deployments',
  'fs.direntStats.section.overview.assetType.FOLDER': 'Folders',
  ...
  'fs.dirent.configOptionsField.label': 'Config options',
  'fs.dirent.descriptionField.label': 'Description',
  'fs.dirent.descriptionField.placeholder': 'Enter a description',
  'fs.dirent.labelsField.label': 'Labels',
  'fs.dirent.labelsField.placeholder': 'Select or add new labels',
  'fs.dirent.article.commentsField.label': 'Comments',
  'fs.dirent.article.linksField.label': 'Associated links',
  'fs.dirent.article.linksEdit.button.label': 'Edit links',
  ...
  'fs.properties.propertyLabel.contentType': 'Link type',
  'fs.properties.propertyLabel.resourceContentType': 'Content type',
  'fs.properties.propertyLabel.preview': 'Preview',
  'fs.dirent.link.contentType.internal': 'Internal',
  'fs.dirent.link.contentType.internal.desc': 'Use for pages in our domain',
  'fs.dirent.link.contentType.external': 'External',
  'fs.dirent.link.contentType.external.desc': 'Use for pages outside our domain',
  'fs.dirent.link.contentType.phone': 'Phone',
  'fs.dirent.link.contentType.phone.desc': 'Use for telephone numbers',
  'fs.dirent.link.sectionTitle.createNew': 'Create new link',
  'fs.dirent.link.sectionTitle.edit': 'Edit link: {name}',
  'fs.dirent.link.urlValueField.label': 'URL or phone number',
  'fs.dirent.link.urlValueField.placeholder': 'Enter link URL or phone number',
  'fs.dirent.link.sectionTitle.localeLabels': 'Labels by language',
  'fs.dirent.locales.labelField': 'Display text in language: {localeCode}',
  'fs.dirent.link.articlesField.label': 'Connected to Articles',
  ...
  'fs.dirent.folder.sectionTitle.edit': 'Edit folder: {name}',
  ...
  'fs.dirent.language.sectionTitle.edit': 'Edit language: {name}',
  ...
  'fs.dirent.language.enabledField.label': 'Status',
  'fs.dirent.language.enabled': 'Enabled',
  'fs.dirent.language.disabled': 'Disabled',
  'fs.dirent.language.enabled.note': 'Enabled: This locale and all of its contents will be displayed on your portal application.',
  'fs.dirent.language.disabled.note': 'Disabled: This locale and all of its contents will be hidden from your portal application.',
  'fs.dirent.service.sectionTitle.createNew': 'Create new workflow',
  'fs.dirent.service.sectionTitle.edit': 'Edit Workflow: {name}',
  'fs.dirent.service.nameField.placeholder': 'Enter workflow name',
  ...
  'fs.dirent.page.sectionTitle.edit': 'Edit page: {name}',
  ...
  'fs.dirent.flow.contentField.label': 'Flow definition',
  'fs.dirent.dialob.sectionTitle.createNew': 'Create new Dialob form',
  'fs.dirent.dialob.sectionTitle.edit': 'Edit Dialob form: {name}',
  'fs.dirent.dialob.technicalNameField.label': 'Technical ID',
  'fs.dirent.dialob.technicalNameField.placeholder': 'Enter technical ID',
  'fs.dirent.dialob.formNameField.label': 'Form name',
  'fs.dirent.dialob.formNameField.placeholder': 'Enter a user-friendly form name',
  'fs.dirent.printout.sectionTitle.createNew': 'Create new printout',
  'fs.dirent.printout.sectionTitle.edit': 'Edit printout: {name}',
  'fs.dirent.printout.nameField.placeholder': 'Enter printout name',
  'fs.dirent.printout.printoutServiceNameField.label': 'Printout service name',
  'fs.dirent.printout.printoutServiceNameField.placeholder': 'Enter printout service name',
  'fs.dirent.printout.orchestratorNameField.label': 'Orchestrator name',
  ...
  'fs.dirent.printoutResource.contentTypeField.label': 'Type',
  'fs.dirent.printoutResource.printoutPagesField.label': 'Used in Printout pages',
  'fs.dirent.printoutResource.uploadBodyField.label': 'Selected content (image or text)',
  'fs.dirent.printoutResource.uploadBodyFieldText.label': 'Script',
  'fs.dirent.printoutResource.uploadBodyField.placeholder': 'No content selected',
  'fs.dirent.printoutResource.uploadBodyField.button': 'Upload content',
  'fs.dirent.printoutPage.sectionTitle.createNew': 'Create new printout page',
  'fs.dirent.printoutPage.sectionTitle.edit': 'Edit printout page: {name}',
  'fs.dirent.printoutPage.serviceIdField.label': 'Printout',
  ...
  'fs.dirent.template.sectionTitle.edit': 'Edit template: {name}',
  'fs.dirent.template.printoutServiceIdField.label': 'Printout',
  'fs.dirent.template.localeIdField.label': 'Locale',
  'fs.dirent.template.contentField.label': 'Content',
  'fs.dirent.flow_task.sectionTitle.createNew': 'Create new flow task',
  'fs.dirent.flow_task.sectionTitle.edit': 'Edit flow task',
  'fs.dirent.flow_task.taskNameField.label': 'Task name',
  'fs.dirent.flow_task.taskNameField.placeholder': 'Enter task name',
  'fs.dirent.flow_task.taskValueField.label': 'Task definition',
  'fs.dirent.decision_table.sectionTitle.createNew': 'Create new decision table',
  'fs.dirent.decision_table.sectionTitle.edit': 'Edit decision table',
  'fs.dirent.decision_table.nameField.placeholder': 'Enter decision table name',
  'fs.dirent.decision_table.nameAndHitpolicy.name': 'Name',
  'fs.dirent.decision_table.nameAndHitpolicy.description': 'Description',
  'fs.dirent.decision_table.nameAndHitpolicy.description.placeholder': 'Enter description',
  'fs.dirent.decision_table.nameAndHitpolicy.hitPolicy': 'Hit-policy',
  'fs.dirent.decision_table.nameAndHitpolicy.hitPolicy.helper': 'Select the hit policy for this decision table',
  'fs.dirent.configOption.DEV_MODE': 'Development mode',
  ...
  'fs.dirent.configOption.RPS_MODE': 'Ratings mode',
  ...
  'fs.dirent.type.folder': 'Folder',
  'fs.dirent.type.article': 'Article',
  'fs.dirent.type.article_workflow': 'Article Workflow',
  'fs.dirent.type.article_template': 'Article Template',
  'fs.dirent.type.article_page': 'Article page',
  'fs.dirent.type.article_link': 'Article Link',
  'fs.dirent.type.dialob_form': 'Dialob form',
  'fs.dirent.type.flow': 'Flow',
  'fs.dirent.type.flow_task': 'Flow task',
  'fs.dirent.type.decision_table': 'Decision table',
  'fs.dirent.type.locale': 'Language',
  'fs.dirent.type.printout': 'Printout',
  'fs.dirent.type.printout_resource': 'Printout resource',
  'fs.dirent.type.printout_page': 'Printout page',
  'fs.dirent.type.image': 'Image',
  'fs.dirent.type.phone': 'Phone number',
  'fs.tabs.new.folder': 'New folder',
  'fs.tabs.new.article': 'New article',
  'fs.tabs.new.article_workflow': 'New workflow',
  'fs.tabs.new.article_template': 'New template',
  'fs.tabs.new.article_link': 'New link',
  ...
  'fs.tabs.new.decision_table': 'New decision table',
  'fs.tabs.new.locale': 'New language',
  'fs.tabs.new.printout': 'New printout',
  'fs.tabs.new.printout_resource': 'New printout resource',
  ...
  'fs.direntMenu.menuItem.duplicate': 'Copy asset',
  'fs.direntCopy.title': 'Copy asset',
  'fs.direntCopy.placeholder': 'New asset name',
  ...
  'fs.direntMenu.deleteDialog.title': 'Delete {type}?',
  'fs.direntMenu.deleteDialog.message': 'Are you sure you want to delete "{name}"? This action cannot be undone.,,,',
  ...
  'fs.main.tooltip.articleLocaleOverview': 'Locale Overview',
  'fs.main.tooltip.stats': 'Asset Statistics',
  ...
  'fs.main.tooltip.overview': 'Overview',
  'fs.main.tooltip.changes': 'Save',
  'fs.panel.message.selectDirent': 'Select an asset from the tree to view details.',
  ...
  'fs.panelOverview.message.noAssets': 'No assets found',
  'fs.panelOverview.column.configOptions': 'Config options',
  'fs.properties.title': 'Properties',
  'fs.properties.message.selectDirent': 'Select an asset from the tree to view properties.',
  ...
  'fs.properties.propertyLabel.serviceName': 'Workflow name',
  'fs.properties.propertyLabel.serviceLocales': 'Workflow Locales',
  'fs.properties.propertyLabel.serviceValidityStart': 'Workflow Validity Start',
  'fs.properties.propertyLabel.serviceValidityEnd': 'Workflow Validity End',
  'fs.properties.propertyLabel.serviceValidityPeriod': 'Workflow Validity Period',
  ...
  'fs.properties.propertyLabel.article': 'Article',
  ...
  'fs.properties.propertyLabel.printoutServiceId': 'Printout',
  'fs.properties.propertyLabel.printoutResources': 'Printout resources',
  ...
  'fs.references.message.selectDirent': 'Select an asset from the tree to view references.',
  ...
  'fs.snackbar.deleteSuccess': 'Deleted {type}: {name}',
  'fs.snackbar.deleteFailed': 'Delete failed',
  'fs.bodyType.LOCALE': 'Locale',
  'fs.bodyType.ARTICLE_LINK': 'Article link',
  'fs.bodyType.ARTICLE': 'Article',
  'fs.bodyType.ARTICLE_WORKFLOW': 'Article workflow',
  'fs.bodyType.ARTICLE_PAGE': 'Article page',
  'fs.bodyType.ARTICLE_TEMPLATE': 'Article template',
  'fs.bodyType.FLOW': 'Flow',
  'fs.bodyType.FLOW_TASK': 'Flow task',
  'fs.bodyType.DECISION_TABLE': 'Decision table',
  'fs.bodyType.DIALOB_FORM': 'Dialob form',
  'fs.bodyType.DIALOB_FORM_META': 'Dialob form meta',
  'fs.bodyType.PRINTOUT': 'Printout',
  ...
  'eveli.metis.search.title': 'Semantic site search',
  'eveli.metis.disabled.title': 'Metis is not enabled',
  'eveli.metis.disabled.body': 'Metis is not enabled in this environment.',
  'eveli.metis.search.disabled.title': 'Semantic site search is not enabled',
  'eveli.metis.search.disabled.body': 'Semantic site search is not enabled in this environment.',
  'eveli.metis.provider': 'Provider',
  'eveli.metis.chatModel': 'Chat model',
  'eveli.metis.embeddingModel': 'Embedding model',
  'eveli.metis.capabilities': 'Capabilities',
  'eveli.metis.capability.site-search': 'Semantic site search',
  'eveli.metis.capability.state.READY': 'Ready',
  'eveli.metis.capability.state.NOT_READY': 'Not ready',
  'eveli.metis.capability.state.DISABLED': 'Disabled',
  'eveli.metis.capability.state.ERROR': 'Error',
  'eveli.metis.search.state.NONE': 'None',
  'eveli.metis.search.state.RUNNING': 'Running',
  'eveli.metis.search.state.CANCELLING': 'Stopping',
  'eveli.metis.search.state.CANCELLED': 'Stopped',
  'eveli.metis.search.state.COMPLETED': 'Completed',
  'eveli.metis.search.state.FAILED': 'Failed',
  'eveli.metis.search.jobState': 'Job state',
  'eveli.metis.search.documents': 'Documents',
  'eveli.metis.search.skipped': 'Skipped',
  'eveli.metis.search.indexed': 'Indexed',
  'eveli.metis.search.publicationId': 'Publication',
  'eveli.metis.search.startedAt': 'Started',
  'eveli.metis.search.finishedAt': 'Finished',
  'eveli.metis.search.fallback': 'The portal is using keyword search until this index finishes.',
  'eveli.metis.search.reindex': 'Reindex',
  'eveli.metis.search.rebuild': 'Rebuild all',
  'eveli.metis.search.stop': 'Stop',
  'eveli.metis.search.rebuild.confirm.title': 'Rebuild the search index?',
  'eveli.metis.search.rebuild.confirm.message': 'This re-embeds every document. It can take a while.',
  'eveli.metis.search.replace.confirm.title': 'Replace the running job?',
  'eveli.metis.search.replace.confirm.message': 'The current reindex will stop and a new one will start.',
  'eveli.metis.search.conflict': 'A reindex is already running.',
