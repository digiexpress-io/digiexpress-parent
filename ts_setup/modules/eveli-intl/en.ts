export const en = {
  ...
  'fs.direntCreate.article.nameField.placeholder': 'Asset name',
  'fs.direntCreate.article.nameField.label': 'Asset name',
  'fs.direntCreate.article.orderNumberField.placeholder': '100',
  'fs.direntCreate.article.orderNumberField.label': '3-digit order number',
  'fs.direntCreate.article.descriptionField.placeholder': 'Description',
  'fs.direntCreate.article.descriptionField.label': 'Description',
  'fs.direntCreate.article.labelsField.placeholder': 'Select or add new labels',
  'fs.direntCreate.article.labelsField.label': 'Labels',
  'fs.direntCreate.article.commentsField.placeholder': 'Notes/comments about this asset',
  'fs.direntCreate.article.commentsField.label': 'Comments',
  'fs.direntCreate.article.configOptionsField.label': 'Configuration options',
  'fs.direntCreate.article.sectionTitle.createNew': 'Create new article',
  'fs.direntCreate.article.sectionTitle.sharing': 'Sharing and permissions',
  'fs.direntCreate.article.expandToggle.show': 'More options',
  'fs.direntCreate.article.expandToggle.hide': 'Fewer options',
  'fs.direntCreate.article.parentArticleField.label': 'Parent article',
  'fs.direntCreate.article.parentArticleField.desc': 'This article will be created as a child of the article below. Please note that child articles may be rendered differently on your client-facing application.',
  'fs.direntCreate.folder.sectionTitle.createNew': 'Create new folder',
  'fs.direntCreate.folder.locationField.label': 'Location',
  'fs.direntCreate.folder.nameField.label': 'Folder name',
  'fs.direntCreate.folder.nameField.placeholder': 'Enter folder name',
  'fs.direntCreate.folder.locationField.root': 'Root',
  'fs.direntCreate.link.sectionTitle.createNew': 'Create new link',
  'fs.direntCreate.link.sectionTitle.createLocaleLabels': 'Add link display text translations',
  'fs.direntCreate.link.valueField.label': 'URL',
  'fs.direntCreate.link.valueField.placeholder': 'https://',
  'fs.direntCreate.link.labelField.en.label': 'Label (EN - English)',
  'fs.direntCreate.link.labelField.fi.label': 'Label (FI - Finnish)',
  'fs.direntCreate.link.labelField.sv.label': 'Label (SV - Swedish)',
  'fs.direntCreate.link.labelField.placeholder': 'Display text for this locale',
  'fs.direntCreate.link.expandToggle.show': 'More options',
  'fs.direntCreate.link.expandToggle.hide': 'Fewer options',
  'fs.direntCreate.link.articlesField.label': 'Articles',
  'fs.direntCreate.link.configOptionsField.label': 'Config options',
  ...
  'fs.direntCreate.phone.sectionTitle.createNew': 'Create new phone number',
  'fs.direntCreate.phone.sectionTitle.createLocaleLabels': 'Add phone number display text translations',
  'fs.direntCreate.phone.phoneValueField.label': 'Phone number',
  'fs.direntCreate.phone.phoneValueField.placeholder': '+358 9 000 0000',
  'fs.direntCreate.phone.labelField.en.label': 'Label (EN - English)',
  'fs.direntCreate.phone.labelField.fi.label': 'Label (FI - Finnish)',
  'fs.direntCreate.phone.labelField.sv.label': 'Label (SV - Swedish)',
  'fs.direntCreate.phone.labelField.placeholder': 'Display text for this locale',
  'fs.direntCreate.phone.expandToggle.show': 'More options',
  'fs.direntCreate.phone.expandToggle.hide': 'Fewer options',
  'fs.direntCreate.phone.articlesField.label': 'Associated articles',
  'fs.direntCreate.phone.configOptionsField.label': 'Config options',
  'fs.direntCreate.service.sectionTitle.createNew': 'Create new service',
  'fs.direntCreate.service.nameField.label': 'Service name',
  'fs.direntCreate.service.nameField.placeholder': 'Enter service name',
  'fs.direntCreate.service.sectionTitle.dialobForm': 'Connect service to Dialob form',
  'fs.direntCreate.service.dialobFormField.label': 'Form',
  'fs.direntCreate.service.dialobTagField.label': 'Version tag',
  'fs.direntCreate.service.flowField.label': 'Flow',
  'fs.direntCreate.service.sectionTitle.createLocaleLabels': 'Add localised service names',
  'fs.direntCreate.service.labelField.placeholder': 'Display text for this language',
  'fs.direntCreate.service.labelField.fi.label': 'Finnish label',
  'fs.direntCreate.service.labelField.sv.label': 'Swedish label',
  'fs.direntCreate.service.labelField.en.label': 'English label',
  'fs.direntCreate.service.expandToggle.show': 'More options',
  'fs.direntCreate.service.expandToggle.hide': 'Fewer options',
  'fs.direntCreate.service.validityStartField.label': 'Valid from',
  'fs.direntCreate.service.validityStartField.placeholder': 'DD.MM.YYYY',
  'fs.direntCreate.service.validityEndField.label': 'Valid until',
  'fs.direntCreate.service.validityEndField.placeholder': 'DD.MM.YYYY',
  'fs.direntCreate.service.articlesField.label': 'Associated articles',
  'fs.direntCreate.service.configOptionsField.label': 'Config options',
  'fs.direntCreate.language.sectionTitle.createNew': 'Create new language',
  'fs.direntCreate.language.localeCodeField.label': 'Locale code',
  'fs.direntCreate.language.localeCodeField.placeholder': 'e.g. en / fi / sv',
  ...
  'fs.direntUpdate.article.sectionTitle.edit': 'Edit article',
  'fs.direntUpdate.article.nameField.label': 'Name',
  'fs.direntUpdate.article.nameField.placeholder': 'Enter article name',
  'fs.direntUpdate.article.orderNumberField.label': 'Order number',
  'fs.direntUpdate.article.orderNumberField.placeholder': 'Enter order number',
  'fs.direntUpdate.article.expandToggle.show': 'More options',
  'fs.direntUpdate.article.expandToggle.hide': 'Fewer options',
  'fs.direntUpdate.article.descriptionField.label': 'Description',
  'fs.direntUpdate.article.descriptionField.placeholder': 'Enter article description',
  'fs.direntUpdate.article.configOptionsField.label': 'Config options',
  'fs.direntUpdate.article.labelsField.label': 'Labels',
  'fs.direntUpdate.article.labelsField.placeholder': 'Enter labels',
  'fs.direntUpdate.article.commentsField.label': 'Comments',
  'fs.direntUpdate.article.commentsField.placeholder': 'Enter comments',
  'fs.direntUpdate.article.sectionTitle.sharing': 'Sharing',
