...
import { ContractCardMenu } from './ContractCardMenu';

import { flashyCardColorsById, ContractCardStyleDefinition, useContractCardThemeConfig } from './cardThemeConfig';
import { ContractCardId, ContractCardStyleKey } from './CardConfigContext';
...
export interface ContractCardProps {
  ...
  styleVariant?: ContractCardStyleKey;
...
export const ContractCard: React.FC<ContractCardProps> = (props) => {
  ...
  return (<>
    {props.editDialog}
    <ContractSectionCard className={classes.dataCard} ownerState={props} id={props.id}>
      ...
      <Box className={classes.title}>
        ...
        <ContractCardMenu cardId={props.id}
          anchorEl={anchorEl}
          open={menuOpen}
...
const MUI_NAME = 'ContractSectionCard';
const ContractSectionCard = styled(Box, {
  name: MUI_NAME,
  slot: 'dataCard',
...
})<{ ownerState: ContractCardProps }>(({ theme, ownerState }) => {
  ...
  const baseStyles: SxProps = {
    ...
    '& .ContractSectionCard-cardBody': {
      backgroundColor: theme.palette.background.default,
      border: `1px solid ${theme.palette.divider}`,
      borderTop: 'none',
    },
    '& .ContractSectionCard-titleNotifier': {
