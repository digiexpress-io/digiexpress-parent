...
export type ContractCardId = string;
export type ContractCardStyleKey = 'compact' | 'default' | 'large';

export interface CardConfig {
  isReviewOpen: boolean;
  editingCardId: string | undefined;
  cardTheme: ContractCardStyleKey;
  cardOrder: string[];
  ...
  setCardTheme(theme: ContractCardStyleKey): void;
}
...
export const CardConfigContextProvider: React.FC<PropsWithChildren<CardConfigContextProviderProps>> = (props) => {
  ...
  const [cardTheme, setCardTheme] = React.useState<ContractCardStyleKey>(props.cardTheme ?? 'default');
