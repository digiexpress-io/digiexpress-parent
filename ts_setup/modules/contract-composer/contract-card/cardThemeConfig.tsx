...
import { ContractCardId, ContractCardStyleKey, useCardConfig } from './CardConfigContext';
...
export interface ContractCardStyleDefinition {
...
export const contractCardGridSize: Record<ContractCardStyleKey | 'singleCol', { xs: number; sm: number; md: number; lg: number; xl: number }> = {
  singleCol,
...
export const useContractCardThemeConfig = (): Record<ContractCardStyleKey, ContractCardStyleDefinition> => {
...
export const flashyCardColorsById: Record<ContractCardId, { flashyBackground: string; flashyBorder: string; contrastText: string }> = {
  'contract_main': {
