...
<<<<<<< HEAD
export const version = '2.0.77';export const build_time = '08/28/2026, 08:09:58';
export const renderVersion = () => VersionInfoApi.builder()
          .setLogo('logo_1_great_ones_wisdom')
          .setTheme('red')
          .setProjectInfo('@dxs-ts/gamut', '2.0.77', '08/28/2026, 08:09:58')
=======
export const version = '2.0.76';export const build_time = '08/31/2026, 12:06:05';
export const renderVersion = () => VersionInfoApi.builder()
          .setLogo('logo_1_great_ones_wisdom')
          .setTheme('red')
          .setProjectInfo('@dxs-ts/gamut', '2.0.76', '08/31/2026, 12:06:05')
>>>>>>> 1cc6101b8 (deleted old deps)
