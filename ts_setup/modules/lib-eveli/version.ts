...
export const version = '2.0.17';export const build_time = '08/19/2025, 12:56:07';
export const renderVersion = () => VersionInfoApi.builder()
          .setLogo('logo_1_great_ones_wisdom')
          .setTheme('red')
          .setProjectInfo('@dxs-ts/eveli-ide', '2.0.17', '08/19/2025, 12:56:07')
          .addInternalComponents(['@dxs-ts/wrench-routes','@dxs-ts/wrench-api','@dxs-ts/stencil-routes','@dxs-ts/stencil-api','@dxs-ts/gamut-theme','@dxs-ts/gamut-shell','@dxs-ts/gamut-md','@dxs-ts/gamut-intl','@dxs-ts/gamut-form-review','@dxs-ts/gamut-form','@dxs-ts/gamut-api','@dxs-ts/eveli-routes','@dxs-ts/eveli-primitives','@dxs-ts/eveli-intl','@dxs-ts/eveli-api','@dxs-ts/envir-util','@dxs-ts/envir-fetch'])
