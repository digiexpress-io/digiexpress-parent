...
export const THEMES: Record<'purple' | 'red', VersionInfoApi.ThemeColors> = {
  purple: {
    logo: 'color: #6A0DAD; font-weight: bold; text-shadow: 0 0 5px #6A0DAD;font-family: "Courier New", monospace;',
  ...
  red: {
    logo: 'color: #DC143C; font-weight: bold; text-shadow: 0 0 10px #DC143C;font-family: "Courier New", monospace;',
