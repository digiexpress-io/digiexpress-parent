...
import { WithFormProvider, useIam, useLocale } from '@dxs-ts/gamut-api'
...
function Component() {
  ...
  return (<>
    <GShell drawerOpen={false}>
      <main role='main'>
        <Container>
          <WithFormProvider id={formId} executionId={''} variant={''} onCancel={onCancel} onAfterComplete={handleOnComplete} formUnavailable={GFormUnavailable}>
