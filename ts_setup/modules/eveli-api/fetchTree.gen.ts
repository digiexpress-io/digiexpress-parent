...
import { Hook as workerRestApiAssetsFsDirentsDescriptionPUT } from './fetch/worker.rest.api.assets.fs.dirents.description.put.ts'
import { Hook as workerRestApiAssetsFsDirentsLabelsPUT } from './fetch/worker.rest.api.assets.fs.dirents.labels.put.ts'
...
const workerRestApiAssetsFsDirentsDescriptionPUTRoute = workerRestApiAssetsFsDirentsDescriptionPUT.update({
  path: 'worker/rest/api/assets/fs/dirents/description',
  method: 'PUT',
})

const workerRestApiAssetsFsDirentsLabelsPUTRoute = workerRestApiAssetsFsDirentsLabelsPUT.update({
  path: 'worker/rest/api/assets/fs/dirents/labels',
  method: 'PUT',
})
...
declare module '@dxs-ts/envir-fetch' {
  interface HookByPath {
    ...
    'worker/rest/api/assets/fs/dirents/description.PUT': {
      id: 'worker/rest/api/assets/fs/dirents/description.PUT',
      path: 'worker/rest/api/assets/fs/dirents/description',
      method: 'PUT',
      params: {},
      hook: typeof workerRestApiAssetsFsDirentsDescriptionPUTRoute
    }

    'worker/rest/api/assets/fs/dirents/labels.PUT': {
      id: 'worker/rest/api/assets/fs/dirents/labels.PUT',
      path: 'worker/rest/api/assets/fs/dirents/labels',
      method: 'PUT',
      params: {},
      hook: typeof workerRestApiAssetsFsDirentsLabelsPUTRoute
    }
