...
import { Hook as workerRestApiAssetsFsDirentsIdDELETE } from './fetch/worker.rest.api.assets.fs.dirents.$id.delete.ts'
import { Hook as workerRestApiAssetsFsDirentsCopyIdPOST } from './fetch/worker.rest.api.assets.fs.dirents.copy.$id.post.ts'
import { Hook as workerRestApiAssetsFsDirentsDescriptionIdPUT } from './fetch/worker.rest.api.assets.fs.dirents.description.$id.put.ts'
import { Hook as workerRestApiAssetsFsDirentsLabelsIdPUT } from './fetch/worker.rest.api.assets.fs.dirents.labels.$id.put.ts'
import { Hook as workerRestApiAssetsFsDirentsNameIdPUT } from './fetch/worker.rest.api.assets.fs.dirents.name.$id.put.ts'
...
import { Hook as workerRestApiTasksInHouseIdGET } from './fetch/worker.rest.api.tasks.in-house.$id.get.ts'
import { Hook as workerRestApiTasksInHouseGET } from './fetch/worker.rest.api.tasks.in-house.get.ts'
...
const workerRestApiAssetsFsDirentsIdDELETERoute = workerRestApiAssetsFsDirentsIdDELETE.update({
  path: 'worker/rest/api/assets/fs/dirents/$id',
  method: 'DELETE',
})

const workerRestApiAssetsFsDirentsCopyIdPOSTRoute = workerRestApiAssetsFsDirentsCopyIdPOST.update({
  path: 'worker/rest/api/assets/fs/dirents/copy/$id',
  method: 'POST',
})

const workerRestApiAssetsFsDirentsDescriptionIdPUTRoute = workerRestApiAssetsFsDirentsDescriptionIdPUT.update({
  path: 'worker/rest/api/assets/fs/dirents/description/$id',
  method: 'PUT',
})

const workerRestApiAssetsFsDirentsLabelsIdPUTRoute = workerRestApiAssetsFsDirentsLabelsIdPUT.update({
  path: 'worker/rest/api/assets/fs/dirents/labels/$id',
  method: 'PUT',
})

const workerRestApiAssetsFsDirentsNameIdPUTRoute = workerRestApiAssetsFsDirentsNameIdPUT.update({
...
const workerRestApiTasksInHouseIdGETRoute = workerRestApiTasksInHouseIdGET.update({
  path: 'worker/rest/api/tasks/in-house/$id',
  method: 'GET',
})

const workerRestApiTasksInHouseGETRoute = workerRestApiTasksInHouseGET.update({
  path: 'worker/rest/api/tasks/in-house',
  method: 'GET',
})
...
declare module '@dxs-ts/envir-fetch' {
  interface HookByPath {
    ...
    'worker/rest/api/assets/fs/dirents/$id.DELETE': {
      ...
      method: 'DELETE',
      params: {id: string},
      hook: typeof workerRestApiAssetsFsDirentsIdDELETERoute
    }
    ...
    'worker/rest/api/assets/fs/dirents/copy/$id.POST': {
      ...
      method: 'POST',
      params: {id: string},
      hook: typeof workerRestApiAssetsFsDirentsCopyIdPOSTRoute
    }
    ...
    'worker/rest/api/assets/fs/dirents/description/$id.PUT': {
      ...
      method: 'PUT',
      params: {id: string},
      hook: typeof workerRestApiAssetsFsDirentsDescriptionIdPUTRoute
    }
    ...
    'worker/rest/api/assets/fs/dirents/labels/$id.PUT': {
      ...
      method: 'PUT',
      params: {id: string},
      hook: typeof workerRestApiAssetsFsDirentsLabelsIdPUTRoute
    }
    ...
    'worker/rest/api/assets/fs/dirents/name/$id.PUT': {
      ...
      method: 'PUT',
      params: {id: string},
      hook: typeof workerRestApiAssetsFsDirentsNameIdPUTRoute
    }
    ...
    'worker/rest/api/tasks/in-house/$id.GET': {
      id: 'worker/rest/api/tasks/in-house/$id.GET',
      path: 'worker/rest/api/tasks/in-house/$id',
      method: 'GET',
      params: {id: string},
      hook: typeof workerRestApiTasksInHouseIdGETRoute
    }

    'worker/rest/api/tasks/in-house.GET': {
      id: 'worker/rest/api/tasks/in-house.GET',
      path: 'worker/rest/api/tasks/in-house',
      method: 'GET',
      params: {},
      hook: typeof workerRestApiTasksInHouseGETRoute
    }
