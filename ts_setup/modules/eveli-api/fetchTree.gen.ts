...
import { Hook as workerRestApiAssetsFsDirentsLinksIdPUT } from './fetch/worker.rest.api.assets.fs.dirents.links.$id.put.ts'
...
const workerRestApiAssetsFsDirentsLinksIdPUTRoute = workerRestApiAssetsFsDirentsLinksIdPUT.update({
  path: 'worker/rest/api/assets/fs/dirents/links/$id',
  method: 'PUT',
})
...
declare module '@dxs-ts/envir-fetch' {
  interface HookByPath {
    ...
    'worker/rest/api/assets/fs/dirents/links/$id.PUT': {
      id: 'worker/rest/api/assets/fs/dirents/links/$id.PUT',
      path: 'worker/rest/api/assets/fs/dirents/links/$id',
      method: 'PUT',
      params: {id: string},
      hook: typeof workerRestApiAssetsFsDirentsLinksIdPUTRoute
    }
