...
export const DEFAULT_ITEM_CONFIG: ItemconfigType = {
  items: [
    ...
    {
      matcher: item => item && item.type === 'group' && item.view === 'page',
      component: GFormReviewPage,
      answerRequired: false,
      childrenRequired: true
    },
    {
      matcher: item => item && item.type === 'group',
      component: GFormReviewGroup,
      answerRequired: false,
      childrenRequired: true
    },
    {
      matcher: item => item && item.type === 'surveygroup',
      component: GFormReviewSurveyGroup,
      answerRequired: false,
      childrenRequired: false
    },
    {
      matcher: item => item && item.type === 'rowgroup',
      component: GFormReviewRowGroup,
      answerRequired: false,
      childrenRequired: false
    },
    {
      matcher: item => item && item.type === 'boolean',
      component: GFormReviewBoolean,
      answerRequired: true,
      childrenRequired: false
    },
    {
      matcher: item => item && item.type === 'text',
      component: GFormReviewText,
      answerRequired: true,
      childrenRequired: false
    },
    {
      matcher: item => item && item.type === 'list',
      component: GFormReviewChoice,
      answerRequired: true,
      childrenRequired: false
    },
    {
      matcher: item => item && item.type === 'multichoice',
    ...
    /*
    {
      matcher: item => item && item.type === 'survey', // Survey is handled within survey GFormReviewGroup
    ...
    */
    {
      matcher: item => item && item.type === 'note',
      component: GFormReviewNote,
      answerRequired: false,
      childrenRequired: false
    },
    {
      matcher: item => item && item.type === 'date',
      component: GFormReviewDate,
      answerRequired: true,
      childrenRequired: false
    },
    {
      matcher: item => item && item.type === 'time',
      component: GFormReviewTime,
      answerRequired: true,
      childrenRequired: false
    },
    {
      matcher: item => item && (item.type === 'number' || item.type === 'decimal'),
