...
export const mockFsDirentProperties: Record<string, FsDirentProps> = {
  ...
  'general-message.service': {
    ...
    dialobFormName: 'dialob-application-form',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-main-service',
    articles: [],
  ...
  'general-message.dialob': {
    ...
    formTechnicalId: 'general-message',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'general-message-ref1': {
    ...
    type: 'service',
    serviceName: 'general-message-ref1',
    dialobFormName: 'dialob-application-form',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-main-service',
    articles: [],
  ...
  'public-inforeq.service': {
    ...
    type: 'service',
    serviceName: 'public-inforeq',
    dialobFormName: 'dialob-service-inquiry',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-main-service',
    articles: [],
  ...
  'public-inforeq.dialob': {
    ...
    type: 'dialob',
    formName: 'Public Information Request',
    formTechnicalId: 'public-inforeq',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [
  ...
  'trustee-info-form.service': {
    ...
    type: 'service',
    serviceName: 'trustee-info-form',
    dialobFormName: 'dialob-application-form',
    dialobFormTag: 'v1.1.0',
    flowName: 'flow-main-service',
    articles: [],
    intlValues: { en: 'Trustee Information Form', fi: 'Luottamushenkilön tietolomake', sv: 'Förtroendevald informationsformulär' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'trustee-info.dialob': {
    ...
    type: 'dialob',
    formName: 'Trustee Information Form',
    formTechnicalId: 'trustee-info',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'trustee-travel-pay.service': {
    ...
    type: 'service',
    serviceName: 'trustee-travel-pay',
    dialobFormName: 'dialob-application-form',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-approval',
    articles: [],
    intlValues: { en: 'Trustee Travel Reimbursement', fi: 'Luottamushenkilön matkakorvaus', sv: 'Förtroendevald reseersättning' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [
  ...
  'trustee-travel-pay.dialob': {
    ...
    type: 'dialob',
    formName: 'Trustee Travel Payment Form',
    formTechnicalId: 'trustee-travel-pay',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'general-message-ref2': {
    ...
    type: 'service',
    serviceName: 'general-message-ref2',
    dialobFormName: 'dialob-application-form',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-main-service',
    articles: [],
  ...
  'wilma-preschool.service': {
    ...
    type: 'service',
    serviceName: 'wilma-preschool',
    dialobFormName: 'dialob-application-form',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-main-service',
    articles: [],
    intlValues: { en: 'Wilma Preschool', fi: 'Wilma-esiopetus', sv: 'Wilma förskola' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'wilma-preschool.dialob': {
    ...
    type: 'dialob',
    formName: 'Wilma Preschool Application',
    formTechnicalId: 'wilma-preschool',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'protection-order-school.service': {
    ...
    type: 'service',
    serviceName: 'protection-order-school',
    dialobFormName: 'dialob-permit-request',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-approval',
    articles: [],
    intlValues: { en: 'Protection Order School', fi: 'Koulun lähestymiskielto', sv: 'Skyddsbeslut skola' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [
  ...
  'protection-order-school.dialob': {
    ...
    type: 'dialob',
    formName: 'Protection Order School Form',
    formTechnicalId: 'protection-order-school',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [
  ...
  'general-message-ref3': {
    ...
    type: 'service',
    serviceName: 'general-message-ref3',
    dialobFormName: 'dialob-application-form',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-main-service',
    articles: [],
  ...
  'dig-permit.service': {
    ...
    type: 'service',
    serviceName: 'dig-permit',
    dialobFormName: 'dialob-permit-request',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-approval',
    articles: [],
    intlValues: { en: 'Digging Permit', fi: 'Kaivulupa', sv: 'Grävtillstånd' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'dig-permit.dialob': {
    ...
    type: 'dialob',
    formName: 'Digging Permit Application',
    formTechnicalId: 'dig-permit',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'rent-street-area.service': {
    ...
    type: 'service',
    serviceName: 'rent-street-area',
    dialobFormName: 'dialob-permit-request',
    dialobFormTag: 'v1.1.0',
    flowName: 'flow-approval',
    articles: [],
    intlValues: { en: 'Street Area Rental', fi: 'Katualueen vuokraus', sv: 'Uthyrning av gatuområde' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'rent-street-area.dialob': {
    ...
    type: 'dialob',
    formName: 'Street Area Rental Application',
    formTechnicalId: 'rent-street-area',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'private-road-sign.service': {
    ...
    type: 'service',
    serviceName: 'private-road-sign',
    dialobFormName: 'dialob-permit-request',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-approval',
    articles: [],
    intlValues: { en: 'Private Road Sign', fi: 'Yksityistien liikennemerkki', sv: 'Privat vägmärke' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [
  ...
  'private-road-sign.dialob': {
    ...
    type: 'dialob',
    formName: 'Private Road Sign Application',
    formTechnicalId: 'private-road-sign',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'general-message-ref4': {
    ...
    type: 'service',
    serviceName: 'general-message-ref4',
    dialobFormName: 'dialob-application-form',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-main-service',
    articles: [],
  ...
  'invoicing-erapaiva.service': {
    ...
    type: 'service',
    serviceName: 'invoicing-erapaiva',
    dialobFormName: 'dialob-service-inquiry',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-notification',
    articles: [],
    intlValues: { en: 'Invoice Due Date Change', fi: 'Laskun eräpäivämuutos', sv: 'Ändring av fakturans förfallodag' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [
  ...
  'invoicing-erapaiva.dialob': {
    ...
    type: 'dialob',
    formName: 'Invoice Due Date Request',
    formTechnicalId: 'invoicing-erapaiva',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'invoice-copy-request.service': {
    ...
    type: 'service',
    serviceName: 'invoice-copy-request',
    dialobFormName: 'dialob-service-inquiry',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-main-service',
    articles: [],
    intlValues: { en: 'Invoice Copy Request', fi: 'Laskukopion pyyntö', sv: 'Begäran om fakturakopia' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'invoice-copy-request.dialob': {
    ...
    type: 'dialob',
    formName: 'Invoice Copy Request',
    formTechnicalId: 'invoice-copy-request',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [
  ...
  'bank-account-info.service': {
    ...
    type: 'service',
    serviceName: 'bank-account-info',
    dialobFormName: 'dialob-application-form',
    dialobFormTag: 'v2.0.0',
    flowName: 'flow-main-service',
    articles: [],
    intlValues: { en: 'Bank Account Information', fi: 'Pankkitilin tiedot', sv: 'Bankkontoinformation' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'bank-account-info.dialob': {
    ...
    type: 'dialob',
    formName: 'Bank Account Information Form',
    formTechnicalId: 'bank-account-info',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'teacher-info.service': {
    ...
    type: 'service',
    serviceName: 'teacher-info',
    dialobFormName: 'dialob-application-form',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-main-service',
    articles: [],
    intlValues: { en: 'Teacher Information', fi: 'Opettajan tiedot', sv: 'Lärarinformation' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'teacher-info.dialob': {
    ...
    type: 'dialob',
    formName: 'Teacher Information Form',
    formTechnicalId: 'teacher-info',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'teacher-travel-pay.service': {
    ...
    type: 'service',
    serviceName: 'teacher-travel-pay',
    dialobFormName: 'dialob-application-form',
    dialobFormTag: 'v1.1.0',
    flowName: 'flow-approval',
    articles: [],
    intlValues: { en: 'Teacher Travel Reimbursement', fi: 'Opettajan matkakorvaus', sv: 'Lärarens reseersättning' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'teacher-travel-pay.dialob': {
    ...
    type: 'dialob',
    formName: 'Teacher Travel Payment Form',
    formTechnicalId: 'teacher-travel-pay',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'study-voucher.service': {
    ...
    type: 'service',
    serviceName: 'study-voucher',
    dialobFormName: 'dialob-application-form',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-main-service',
    articles: [],
    intlValues: { en: 'Study Voucher', fi: 'Opiskeluseteli', sv: 'Studiesedel' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'study-voucher.dialob': {
    ...
    type: 'dialob',
    formName: 'Study Voucher Application',
    formTechnicalId: 'study-voucher',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'general-message-ref5': {
    ...
    type: 'service',
    serviceName: 'general-message-ref5',
    dialobFormName: 'dialob-application-form',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-main-service',
    articles: [],
  ...
  'water-supply-maintenance.service': {
    ...
    flowName: 'flow-notification',
    articles: [],
    intlValues: { en: 'Water Supply Maintenance', fi: 'Vesijohtohuolto', sv: 'Vattenledningsunderhåll' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'water-supply-maintenance.dialob': {
    ...
    type: 'dialob',
    formName: 'Water Supply Maintenance Request',
    formTechnicalId: 'water-supply-maintenance',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'water-invoice-erapaiva.service': {
    ...
    type: 'service',
    serviceName: 'water-invoice-erapaiva',
    dialobFormName: 'dialob-service-inquiry',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-notification',
    articles: [],
    intlValues: { en: 'Water Invoice Due Date Change', fi: 'Vesimaksun eräpäivämuutos', sv: 'Ändring av vattenräkningens förfallodag' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'water-invoice-erapaiva.dialob': {
    ...
    type: 'dialob',
    formName: 'Water Invoice Due Date Request',
    formTechnicalId: 'water-invoice-erapaiva',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'water-connection-statement.service': {
    ...
    type: 'service',
    serviceName: 'water-connection-statement',
    dialobFormName: 'dialob-permit-request',
    dialobFormTag: 'v2.0.0',
    flowName: 'flow-approval',
    articles: [],
    intlValues: { en: 'Water Connection Statement', fi: 'Vesihuoltoliittymälausunto', sv: 'Vattenanslutningsutlåtande' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'water-connection-statement.dialob': {
    ...
    type: 'dialob',
    formName: 'Water Connection Statement Form',
    formTechnicalId: 'water-connection-statement',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'general-message-ref6': {
    ...
    type: 'service',
    serviceName: 'general-message-ref6',
    dialobFormName: 'dialob-application-form',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-main-service',
    articles: [],
  ...
  'sports-grant-settlement.service': {
    ...
    type: 'service',
    serviceName: 'sports-grant-settlement',
    dialobFormName: 'dialob-application-form',
    dialobFormTag: 'v1.1.0',
    flowName: 'flow-approval',
    articles: [],
    intlValues: { en: 'Sports Grant Settlement', fi: 'Urheiluavustuksen selvitys', sv: 'Idrottsbidragets redovisning' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'sports-grant-settlement.dialob': {
    ...
    type: 'dialob',
    formName: 'Sports Grant Settlement Form',
    formTechnicalId: 'sports-grant-settlement',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'sports-fee-return.service': {
    ...
    type: 'service',
    serviceName: 'sports-fee-return',
    dialobFormName: 'dialob-application-form',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-approval',
    articles: [],
    intlValues: { en: 'Sports Fee Return', fi: 'Urheilumaksun palautus', sv: 'Återbetalning av idrottsavgift' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [
  ...
  'sports-fee-return.dialob': {
    ...
    type: 'dialob',
    formName: 'Sports Fee Return Application',
    formTechnicalId: 'sports-fee-return',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'children-sport-grant.service': {
    ...
    type: 'service',
    serviceName: 'children-sport-grant',
    dialobFormName: 'dialob-application-form',
    dialobFormTag: 'v1.0.0',
    flowName: 'flow-approval',
    articles: [],
    intlValues: { en: 'Children Sport Grant', fi: 'Lasten urheiluavustus', sv: 'Barns idrottsbidrag' },
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'children-sport-grant.dialob': {
    ...
    type: 'dialob',
    formName: 'Children Sport Grant Application',
    formTechnicalId: 'children-sport-grant',
    expanded: false,
    reference: false,
    locked: false,
    configOptions: [],
  ...
  'new-construction-permit.printout': {
    ...
    errors: [],
    printoutServiceName: 'pdf-generator-service',
    orchestratorName: 'orchestrator-main',
    intlValues: { en: 'New Construction Permit Printout', fi: 'Uuden rakennusluvan tuloste', sv: 'Utskrift för nytt bygglov' }
  },
  'fi-construction-permit': {
    ...
    labels: [],
    errors: [],
    serviceId: 'printout-service-construction-permit',
    localeId: 'fi'
  },
  ...
  'municipal-services-guide.printout': {
    ...
    errors: [],
    printoutServiceName: 'generic-header',
    orchestratorName: 'taskSplitFlow.flow',
    intlValues: { en: 'Municipal Services Guide Printout', fi: 'Kunnan palveluoppaan tuloste', sv: 'Utskrift för kommunal servicehandbok' }
  },
  'fi-services-guide': {
    ...
    labels: [],
    errors: [],
    serviceId: 'printout-service-municipal-services-guide',
    localeId: 'fi'
  },
  'sv-services-guide': {
  ...
  'waste-management-info.printout': {
    ...
    labels: [],
    errors: [],
    printoutServiceName: 'waste-management-info',
    orchestratorName: 'shared-taskGenericFlow.flow',
    intlValues: { en: 'Waste Management Information Printout', fi: 'Jätehuollon tiedotteen tuloste', sv: 'Utskrift för avfallshanteringsinformation' }
  },
  'fi-waste-info': {
    id: 'fi-waste-info',
    type: 'template',
    ...
    labels: [],
    errors: [],
    serviceId: 'printout-service-waste-management',
    localeId: 'fi'
  },
  'tax-information-leaflet.printout': {
    ...
    printoutServiceName: 'pdf-generator-service',
    orchestratorName: 'orchestrator-main',
    intlValues: { en: 'Tax Information Leaflet Printout', fi: 'Verotietolehtisen tuloste', sv: 'Utskrift för skatteinformationsbroschyr' }
  },
  'fi-tax-info': {
    id: 'fi-tax-info',
    type: 'template',
    ...
    labels: [],
    errors: [],
    serviceId: 'printout-service-tax-information',
    localeId: 'fi'
  },
  'sv-tax-info': {
    id: 'sv-tax-info',
