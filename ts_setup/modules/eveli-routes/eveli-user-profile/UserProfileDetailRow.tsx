...
import { Chip, Grid2, lighten, Typography, useTheme } from '@mui/material';
...
export const UserProfileRolesRowChip: React.FC<{ label: React.ReactNode, value: string }> = ({ label, value }) => {
