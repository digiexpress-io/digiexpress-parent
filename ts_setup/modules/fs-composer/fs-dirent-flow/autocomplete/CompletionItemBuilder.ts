...
export class CompletionItemBuilder {
  ...
  lineNumber(lineNumber: number): CompletionItemBuilder {
    this._position = this._position.with(lineNumber, this._position.column);
    return this;
  }

  id(id: string): CompletionItemBuilder {
    this._id = id;
    return this;
  }

  append(append: boolean): CompletionItemBuilder {
    this._append = append;
    return this;
  }
  guided(guided: GuidedType): CompletionItemBuilder {
    this._guided = guided;
    return this;
  }
  ...
  addValue(value: string): CompletionItemBuilder {
    this._value += value;
    return this;
  }
