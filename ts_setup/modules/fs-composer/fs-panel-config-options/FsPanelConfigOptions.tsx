...
import { FsPanelConfigOptionsRoot, useUtilityClasses } from './useUtilityClasses';
import { Fs, useFsDirent } from '@dxs-ts/fs-api';

export const FsPanelConfigOptions: React.FC<FsPanelConfigOptionsProps> = (props) => {
  const intl = useIntl();
  ...
  return (
    <FsPanel title={intl.formatMessage({ id: 'fs.configOptions.title.direntName' }, { direntName })}
      ...
      <FsPanelConfigOptionsRoot className={classes.root} ownerState={ownerState}>
