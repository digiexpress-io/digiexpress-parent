...
import { FsArticleOrderRoot, useUtilityClasses } from './useUtilityClasses';


export const FsArticleOrder: React.FC<FsArticleOrderProps> = (props) => {
  const intl = useIntl();
  ...
  return (
    <FsPanel
      ...
      activeDirent={true}
    >
      <FsArticleOrderRoot className={classes.root} ownerState={ownerState}>
