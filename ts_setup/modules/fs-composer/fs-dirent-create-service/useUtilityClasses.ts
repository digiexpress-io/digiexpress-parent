...
const MUI_NAME = 'FsDirentCreateService';

export interface FsDirentCreateServiceClasses {
  root: string;
  title: string;
...
export type FsDirentCreateServiceClassKey = keyof FsDirentCreateServiceClasses;
...
export const FsDirentCreateServiceRoot = styled('div', {
  name: MUI_NAME,
  slot: 'Root',
