...
const CellEdit: React.FC<CellEditProps> = (props) => {
  ...
  const header: Fs.TypeDef = [...props.dt.headers.acceptDefs, ...props.dt.headers.returnDefs]
    ...
    >
      ...
      <DialogActions>
        ...
        <FsDirentButtonSave onClick={() => {
          ...
          const command: Fs.AstCommand = { id: props.cell.id, value: normalized as any, type: 'SET_CELL_VALUE' };
