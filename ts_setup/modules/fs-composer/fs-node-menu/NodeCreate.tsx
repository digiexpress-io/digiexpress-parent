...
const configOptions = [
  { value: 'devMode', label: 'Development', icon: <FsIcons.DevMode fontSize='small' /> },
  { value: 'assignableMode', label: 'Assignable', icon: <FsIcons.Assignment fontSize='small' /> },
  { value: 'disabledMode', label: 'Disabled', icon: <FsIcons.Disabled fontSize='small' /> },
  { value: 'anonymousMode', label: 'Anonymous', icon: <FsIcons.Anonymous fontSize='small' /> },
];
