...
const MUI_NAME = 'FsDirentMultiSelect';

export interface FsDirentMultiSelectClasses {
  root: string;
  select: string;
...
export type FsDirentMultiSelectClassKey = keyof FsDirentMultiSelectClasses;
...
export const FsDirentMultiSelectRoot = styled(FormControl, {
  name: MUI_NAME,
  slot: 'Root',
